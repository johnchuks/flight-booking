# Generated by Django 2.1.3 on 2018-11-11 09:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='flight',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='NGN', max_digits=14),
        ),
        migrations.AddField(
            model_name='flight',
            name='price_currency',
        ...
        migrations.AddField(
            model_name='ticket',
            name='status',
            field=models.CharField(choices=[('RESERVED', 'Reserved'), ('BOOKED', 'Booked'), ('CONFIRMED', 'Confirmed')], default='RESERVED', max_length=50),
        ),
    ]
